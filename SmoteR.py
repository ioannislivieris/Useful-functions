...
def get_synth_cases(D, target, o=200, k=3, categorical_col = []):
    ...
    # initialize the list of new cases 
    #
    new_cases = pd.DataFrame(columns = D.columns) 
    
    # the number of new cases to generate
    #
    ng = o // 100 
...
#         k  - the number of nearest neighbors
#
# SmoteR(df, target='target_variable', th = 0.999, o = 300, u = 100, k = 1, categorical_col = [])